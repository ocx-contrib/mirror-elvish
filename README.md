...
expressive programming language. Publishes CDN releases to `ocx.sh/elvish`
with cascade tags after a smoke test per `(version, platform)`.
...
| `generate.py` | hand | `ocx-mirror pipeline generate ci` |
